...
void AdvancedToolBox::setStylesheet(QString color)
{
    QString stylesheet;
    stylesheet += "AdvancedToolBox::tab{border-radius: 5px; padding: 5px; border: 0px solid;background:"+color+"; color: black; }";
    stylesheet += "AdvancedToolBox::tab:hover{background:#d5e6ed;}";
    stylesheet += "AdvancedToolBox::branch:closed{image: url(:/image/images/routine/right_arrow.png);width: 30px;padding: 5px;}";
    stylesheet += "AdvancedToolBox::branch{image: url(:/image/images/routine/right_arrow_down.png);width: 30px;padding: 5px;}";
...
void CollpasePage::setStyle(QString color)
{
    m_advancedToolBox->setStylesheet(color);
}
