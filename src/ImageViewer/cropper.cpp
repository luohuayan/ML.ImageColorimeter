...
Cropper::Cropper(QObject* parent, QString imgpath, int startx, int starty, int width, int hegiht, QRgb rgba,int index) :
...
void Cropper::contextMenuEvent(QGraphicsSceneContextMenuEvent* event)
{
    ...
    QAction* removeAllAction = new QAction("DeleteAll ROI", &menu);
