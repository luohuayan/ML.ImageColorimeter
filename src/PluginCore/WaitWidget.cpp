...
WaitWidget::WaitWidget(QWidget *parent) : QWidget(parent)
{
    ...
    //effect2
    m_color[0] = QColor(173, 206, 218);
    m_color[1] = QColor(173, 206, 218);
    m_color[2] = QColor(173, 206, 218);
    m_color[3] = QColor(173, 206, 218);
    m_color[4] = QColor(173, 206, 218);
    m_color[5] = QColor(173, 206, 218);
    m_color[6] = QColor(173, 206, 218);
    m_color[7] = QColor(173, 206, 218);
